...
import { Building2, ArrowLeft, Calendar, MapPin, DollarSign, Users, Filter } from "lucide-react"
import { MobileNav } from "@/components/mobile-nav"
import { projectsData } from "@/lib/projectsData" // Import the centralized data
      ...
      <section className="bg-gradient-to-r from-blue-700 to-purple-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Our Projects Portfolio</h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Explore our completed and ongoing construction projects. Each project showcases our commitment to quality,
            ...
            <div className="flex flex-wrap gap-2">
              {categories.map((category) => (
                <Button
                  ...
                  size="sm"
                  className={category === activeFilter ? "bg-blue-600 hover:bg-blue-700" : ""}
                >
                  {category}
                </Button>
              ))}
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-3">
                    <Link href={`/projects/${project.id}`} className="flex-1">
                      <Button className="w-full bg-gradient-to-r from-blue-700 to-purple-800 hover:from-blue-800 hover:to-purple-900 transition-all duration-300 text-sm">
                        View Details
                      </Button>
                    </Link>
